...
| 2026-09-27 | [Issue 14: Global directory classification](research/2026-09-27-issue-14-global-directory-classification/) | preregistered | pending | Tests complete-population directory classification followed by direct-file scoring against the uncapped path baseline; Actions run pending. |
