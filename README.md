...
| 2026-09-26 | [Uncapped weighted path score frontier V5](research/2026-09-26-uncapped-weighted-path-score-frontier-v5/) | preregistered | pending | Replay eleven metadata score thresholds across all paths with zero model calls to test count/recall tradeoffs before further scoring. |
