...
| 2026-09-26 | [Exact primary-safe weighted frontier V6](research/2026-09-26-exact-primary-safe-weighted-frontier-v6/) | preregistered | pending | Compute the exact smallest scalar-threshold candidate set that retains every labeled primary file, removing score-grid uncertainty. |
