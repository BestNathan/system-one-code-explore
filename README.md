...
| 2026-09-26 | [Issue 13: Progressive repository state machine](research/2026-09-26-issue-13-progressive-repository-state-machine/) | preregistered | pending | Tests progressive disclosure with durable unresolved directories against uncapped semantic path retrieval; Workflow results pending. |
