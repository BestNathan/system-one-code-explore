...
| R09 | [Uncertainty calibration and search policy](2026-09-24-r09-uncertainty-calibration-search-policy.md) | current | Keep multi-scale relevance fixed, decouple exploration uncertainty from adaptive-kernel support, and validate search on fresh holdouts. |\n| R10 | [Phase0 to final evidence quality](2026-09-25-r10-final-evidence-quality.md) | current parallel | Evaluate the literal downstream code snippets produced from completed Phase0 trajectories under a fixed evidence budget. |\n| R11 | [System One relevance prompt calibration](2026-09-25-r11-system-one-prompt-calibration.md) | current parallel | Use full-read System 2 fields as supervision to discover local scoring prompts that separate useful code from incidental context. |
