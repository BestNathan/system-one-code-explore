...
| 2026-09-26 | [CamelCase concept normalization V4](2026-09-26-camel-case-concept-normalization-v4/) | preregistered | pending | Test the isolated WebSocket tokenization correction against the unchanged three-arm, three-repository comparison. |
