...
| 2026-09-26 | [Uncapped weighted path score frontier V5](2026-09-26-uncapped-weighted-path-score-frontier-v5/) | preregistered | pending | Measure candidate/recall tradeoffs across every concept-matching path and a frozen score-threshold grid, with no model calls. |
