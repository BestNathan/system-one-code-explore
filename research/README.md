...
| 2026-09-26 | [Concept-weighted retrieval and provenance rescue V3](2026-09-26-concept-weighted-retrieval-provenance-rescue/) | preregistered | pending | Compare concept-deduplicated weighted paths and evidence-based low-score rescue with the stable repository-wide guard; no candidate cap. |
